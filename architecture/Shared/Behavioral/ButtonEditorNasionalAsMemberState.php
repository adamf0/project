...
class ButtonEditorNasionalAsMemberState extends MappingHtmlOrmStateInterface{
    ...
    public function handle() {
        ...
        $this->output .= "
            <form action='".route('penelitianNasional.verificationMember')."' method='POST'>
                <input type='hidden' name='status' value='1'/>
                <input type='hidden' name='id_penelitian_nasional' value='".$this->item->GetId()."'/>
